...
// Realtime Hearing AI -
//
// This is the Standard Version, it isn't much different from the web player version but a few lines of code
// This version is made for Computers and Mobile devices (Tested on Android 4.4.3). Should work on any
// device with a Microphone built into it.
//
// Web Player version had to be made differently because of legal restrictions about accessing
// the Microphone while on a browser, it is your legal choice which to choose.
// But I in no way take responsibility if you choose to use this over a web playr game.
...
public class Standard : MonoBehaviour {
		...
		public bool StandardPlayerTrue; // -------------- If this is the Standard Player, and is true, then start audio.
		...
		public float ClearRamTimer = 30; // --------------------- How often to clear memory.
